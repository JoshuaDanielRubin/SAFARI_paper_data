...
def plot_sensitivity_high_damage_k29_w11(data_path, output_path, dist):
    # Load data
    data = pd.read_csv(data_path)

    # Filtering data for 'High' damage level and specific k=29 and w=11
    filtered_data = data[(data['damage_level'] == 'High') & (data['k'] == 29) & (data['w'] == 11)]
    ...
    plt.title(f'Sensitivity vs Specificity (k=29, w=11, High Damage, {dist})', fontsize=16, fontweight='bold')
...
if __name__ == '__main__':
    ...
    dist = sys.argv[3]
    plot_sensitivity_high_damage_k29_w11(data_path, output_path, dist)
